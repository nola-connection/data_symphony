...
#
#     PHX_SERVER=true bin/data_symphony start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :data_symphony, DataSymphonyWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :data_symphony, DataSymphony.Repo,
    # Neon (and most managed Postgres) requires TLS. See docs/06-database-setup.md.
    ssl: true,
    url: database_url,
